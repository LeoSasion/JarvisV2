...
// Windows 10-owned host-side lifecycle contract for one pre-admitted Explorer
// UI thread. This component owns neither target discovery nor DLL loading; the
// Win10 collector supplies those gates and links this reviewed Win32 adapter.
